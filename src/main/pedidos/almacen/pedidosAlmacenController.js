const pedidosAlmacen = require('./pedidosAlmacen');
...
class pedidosAlmacenController {
  ...
  static async create(req, res) {
    ...
    return pedidosAlmacenController._handleRequest(res, 'create', req, async () => {
      return await pedidosAlmacen.create({
        user_id,
        personal_id,
        sucu_id,
        sucursal_destino_id,
  ...
  static async update(req, res) {
    ...
    return pedidosAlmacenController._handleRequest(res, 'update', req, async () => {
      return await pedidosAlmacen.update(id, {
        observaciones: observaciones || null,
        precio_id,
        sucursal_destino_id,
        agrupado: !!agrupado,
  ...
  static async delete(req, res) {
    const { id } = req.params;
    return pedidosAlmacenController._handleRequest(res, 'delete', req, async () => {
      return await pedidosAlmacen.delete(id);
    }, {
