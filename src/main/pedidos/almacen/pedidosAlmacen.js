...
class pedidosAlmacen {
  ...
  // Crear pedido - inserción en lote
  ...
  // Actualizar pedido - inserción en lote de detalles
  static async update(pedidoId, { observaciones, precio_id, sucursal_destino_id, agrupado, productos, fecha }) {
    try {
  ...
  static async delete(pedidoId) {
    try {
      ...
      console.error('Error en pedidosAlmacen.delete:', error);
      return {
        success: false,
        message: error.message
      };
